...
const customers = [
    { id: 1, name: 'Marco', purchases: 150, category: 'electronics' },
    { id: 2, name: 'Anna', purchases: 300, category: 'fashion' },
    { id: 3, name: 'Luca', purchases: 90, category: 'electronics' },
    { id: 4, name: 'Sofia', purchases: 250, category: 'fashion' }
];
